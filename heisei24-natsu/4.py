...
def draw_board(base: list[list[str]], bullet_ichis: list[tuple[int, int]], mokuhyou_ichi: tuple[int, int], spawn_x: int) -> list[list[str]]:
...
def main():
    ...
    while True:
        ...
        board = draw_board(base, bullet_ichis, mokuhyou_ichi, spawn_x)
        print_board(board)
